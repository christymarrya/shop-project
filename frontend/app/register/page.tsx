...
import { ShieldAlert, User, Lock, AlertCircle, CheckCircle, ShoppingBag } from 'lucide-react';
    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-slate-100 p-4">
      ...
      <div className="w-full max-w-md bg-[#111] border border-slate-800 rounded-lg shadow-2xl p-8 relative z-10">
        <div className="flex flex-col items-center mb-6">
          <div className="p-3 bg-[#febd69]/10 rounded-full border border-[#febd69]/30 mb-3">
            <ShoppingBag className="h-8 w-8 text-[#febd69]" />
          </div>
          <h2 className="text-2xl font-extrabold text-white">ShopZone</h2>
          <p className="text-xs text-slate-400 mt-1">Welcome to ShopZone</p>
        </div>
